...
function createBlock(name) {
  ...
  var attributes = (0, _lodash.reduce)(blockType.attributes, function (result, source, key) {
...
var isPossibleTransformForSource = function isPossibleTransformForSource(transform, direction, blocks) {
  ...
  var sourceBlock = (0, _lodash.first)(blocks); // If multiple blocks are selected, only multi block transforms are allowed.
...
function getPossibleBlockTransformations(blocks) {
  ...
  return (0, _lodash.uniq)((0, _toConsumableArray2.default)(blockTypesForFromTransforms).concat((0, _toConsumableArray2.default)(blockTypesForToTransforms)));
}
/**
...
function getBlockTransforms(direction, blockName) {
  ...
  var _ref2 = (0, _registration.getBlockType)(blockName) || {},
