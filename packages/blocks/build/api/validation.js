...
exports.isEqualTextTokensWithCollapsedWhitespace = isEqualTextTokensWithCollapsedWhitespace;
...
exports.isEqualTokensOfType = exports.isEqualAttributesOfName = void 0;
...
function isEqualTextTokensWithCollapsedWhitespace(actual, expected) {
  ...
  var isEquivalentText = _lodash.isEqual.apply(void 0, (0, _toConsumableArray2.default)([actual.chars, expected.chars].map(getTextWithCollapsedWhitespace)));
...
function getHTMLTokens(html) {
  try {
    return (0, _simpleHtmlTokenizer.tokenize)(html);
  } catch (e) {
...
function isValidBlock(innerHTML, blockType, attributes) {
  (0, _deprecated.default)('isValidBlock', {
    plugin: 'Gutenberg',
    version: '4.4',
