...
import { PREFERENCES_DEFAULTS, EDITOR_SETTINGS_DEFAULTS, INITIAL_EDITS_DEFAULTS } from './defaults';
...
withHistory({
  ...
  blocks: flow([combineReducers, // Track whether changes exist, resetting at each post save. Relies on
