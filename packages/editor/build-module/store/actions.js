...
export var createSuccessNotice = partial(createNotice, 'success');
export var createInfoNotice = partial(createNotice, 'info');
export var createErrorNotice = partial(createNotice, 'error');
export var createWarningNotice = partial(createNotice, 'warning'); //
// Deprecated
//
