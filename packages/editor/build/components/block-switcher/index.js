    ...
    value: function render() {
      ...
      return (0, _element.createElement)(_components.Dropdown, {
        ...
        renderToggle: function renderToggle(_ref2) {
          ...
          var label = 1 === blocks.length ? (0, _i18n.__)('Change block type') : (0, _i18n.sprintf)((0, _i18n._n)('Change type of %d block', 'Change type of %d blocks', blocks.length), blocks.length);
          return (0, _element.createElement)(_components.Toolbar, null, (0, _element.createElement)(_components.IconButton, {
...
var _default = (0, _compose.compose)((0, _data.withSelect)(function (select, _ref4) {
  ...
  return {
    onTransform: function onTransform(blocks, name) {
      dispatch('core/editor').replaceBlocks(ownProps.clientIds, (0, _blocks.switchToBlockType)(blocks, name));
    }
  };
}))(BlockSwitcher);
