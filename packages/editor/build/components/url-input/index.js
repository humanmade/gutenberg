  ...
  (0, _createClass2.default)(URLInput, [{
    ...
    value: function updateSuggestions(value) {
      ...
      request.then(function (posts) {
        ...
        if (!!posts.length) {
          _this4.props.debouncedSpeak((0, _i18n.sprintf)((0, _i18n._n)('%d result found, use up and down arrow keys to navigate.', '%d results found, use up and down arrow keys to navigate.', posts.length), posts.length), 'assertive');
        } else {
    ...
    value: function render() {
      ...
      return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)("div", {
        ...
        ref: this.inputRef
      }), loading && (0, _element.createElement)(_components.Spinner, null)), showSuggestions && !!posts.length && (0, _element.createElement)(_components.Popover, {
        position: "bottom",
        noArrow: true,
        focusOnMount: false
        ...
        return (0, _element.createElement)("button", {
          ...
          className: (0, _classnames.default)('editor-url-input__suggestion', {
        ...
        }, (0, _htmlEntities.decodeEntities)(post.title) || (0, _i18n.__)('(no title)'));
      }))));
...
var _default = (0, _components.withSpokenMessages)((0, _compose.withInstanceId)(URLInput));
