...
function (_Component) {
  ...
  (0, _createClass2.default)(BlockInsertionPoint, [{
    ...
    value: function render() {
      ...
      return (0, _element.createElement)("div", {
      ...
      }), canShowInserter && (0, _element.createElement)("div", {
        ...
        ,
        tabIndex: -1,
        className: (0, _classnames.default)('editor-block-list__insertion-point-inserter', {
...
var _default = (0, _data.withSelect)(function (select, _ref) {
  ...
  var showInsertionPoint = isBlockInsertionPointVisible() && insertionPoint.index === insertIndex && insertionPoint.rootClientId === rootClientId && !(0, _blocks.isUnmodifiedDefaultBlock)(block);
  return {
