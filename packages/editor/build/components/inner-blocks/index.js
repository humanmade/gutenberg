  ...
  (0, _createClass2.default)(InnerBlocks, [{
    ...
    value: function render() {
      var _this$props5 = this.props,
          ...
          allowedBlocks = _this$props5.allowedBlocks,
          templateLock = _this$props5.templateLock,
      ...
      var classes = (0, _classnames.default)('editor-inner-blocks', {
        'has-overlay': isSmallScreen && !isSelectedBlockInRoot
      });
      return (0, _element.createElement)("div", {
        className: classes
      }, (0, _element.createElement)(_blockList.default, (0, _extends2.default)({
...
InnerBlocks = (0, _compose.compose)([(0, _context.withBlockEditContext)(function (context) {
  ...
  return {
    replaceInnerBlocks: function replaceInnerBlocks(blocks) {
      var clientIds = (0, _lodash.map)(block.innerBlocks, 'clientId');
