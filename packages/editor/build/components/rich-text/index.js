...
Object.defineProperty(exports, "RichTextInserterItem", {
  enumerable: true,
  get: function get() {
    return _inserterListItem.RichTextInserterItem;
  }
});
...
var _inserterListItem = require("./inserter-list-item");
  ...
  (0, _createClass2.default)(RichText, [{
    ...
    value: function onKeyDown(event) {
      ...
      if (keyCode === _keycodes.DELETE || keyCode === _keycodes.BACKSPACE) {
        ...
        var end = (0, _richText.getSelectionEnd)(value); // Always handle uncollapsed selections ourselves.

        if (!(0, _richText.isCollapsed)(value)) {
          this.onChange((0, _richText.remove)(value));
          event.preventDefault();
          return;
        }
        ...
        if (this.multilineTag) {
          ...
          if (keyCode === _keycodes.BACKSPACE) {
            if ((0, _richText.charAt)(value, start - 1) === _richText.LINE_SEPARATOR) {
              newValue = (0, _richText.remove)(value, // Only remove the line if the selection is
              // collapsed.
              (0, _richText.isCollapsed)(value) ? start - 1 : start, end);
            }
          } else if ((0, _richText.charAt)(value, end) === _richText.LINE_SEPARATOR) {
            newValue = (0, _richText.remove)(value, start, // Only remove the line if the selection is collapsed.
...
RichTextContainer.Content = function (_ref7) {
  var value = _ref7.value,
      ...
      props = (0, _objectWithoutProperties2.default)(_ref7, ["value", "tagName", "multiline"]);
  var html = value;
  var MultilineTag;
