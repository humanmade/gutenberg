...
function (_Component) {
  ...
  (0, _createClass2.default)(RichText, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      if (this.lastEventCount && nextProps.value && this.lastContent && nextProps.value === this.lastContent) {
        return false;
      ...
      if (nextProps.value && this.lastContent && nextProps.value !== this.lastContent) {
    ...
    value: function render() {
      ...
      return (0, _element.createElement)(_reactNative.View, null, (0, _element.createElement)(_editor.BlockFormatControls, null, (0, _element.createElement)(_components.Toolbar, {
