...
exports.default = exports.TINYMCE_ZWSP = void 0;
...
exports.TINYMCE_ZWSP = TINYMCE_ZWSP;
...
/*#__PURE__*/
function (_Component) {
  (0, _inherits2.default)(TinyMCE, _Component);

  function TinyMCE() {
    var _this;

    (0, _classCallCheck2.default)(this, TinyMCE);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(TinyMCE).call(this));
  ...
  (0, _createClass2.default)(TinyMCE, [{
    key: "onFocus",
    ...
    value: function shouldComponentUpdate(nextProps) {
      ...
      if (!(0, _lodash.isEqual)(this.props.className, nextProps.className)) {
        this.editorNode.className = (0, _classnames.default)(nextProps.className, 'editor-rich-text__tinymce');
      }
    ...
    value: function initialize() {
      ...
      _tinymce.default.init((0, _objectSpread3.default)({}, settings, {
    ...
    value: function onKeyDown(event) {
      ...
      var _getSelection$getRang = getSelection().getRangeAt(0),
          startContainer = _getSelection$getRang.startContainer,
          startOffset = _getSelection$getRang.startOffset,
          endContainer = _getSelection$getRang.endContainer,
          endOffset = _getSelection$getRang.endOffset;

      var isCollapsed = startContainer === endContainer && startOffset === endOffset; // Disables TinyMCE behaviour.

      if (keyCode === _keycodes.ENTER || !isCollapsed && (keyCode === _keycodes.DELETE || keyCode === _keycodes.BACKSPACE)) {
      ...
      var isReverse = event.keyCode === _keycodes.LEFT;
      ...
      if (!focusNode[edgeSibling]) {
        ...
        event.preventDefault = _lodash.noop;
      }
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return (0, _element.createElement)(tagName, (0, _objectSpread3.default)({}, ariaProps, (_objectSpread2 = {
        className: (0, _classnames.default)(className, 'editor-rich-text__tinymce'),
        ...
        __html: defaultValue
      }), (0, _defineProperty2.default)(_objectSpread2, "onPaste", onPaste), (0, _defineProperty2.default)(_objectSpread2, "onInput", onInput), (0, _defineProperty2.default)(_objectSpread2, "onFocus", this.onFocus), (0, _defineProperty2.default)(_objectSpread2, "onKeyDown", onKeyDown), (0, _defineProperty2.default)(_objectSpread2, "onKeyUp", onKeyUp), _objectSpread2)));
    }
  }]);
  return TinyMCE;
}(_element.Component);
