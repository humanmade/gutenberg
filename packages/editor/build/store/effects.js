...
var _default = {
  ...
  SETUP_EDITOR: function SETUP_EDITOR(action, store) {
    ...
    var blocks = (0, _blocks.parse)(content); // Apply a template for new posts only, if exists.
    ...
    var setupAction = (0, _actions.setupEditorState)(post, blocks);
  ...
  MULTI_SELECT: function MULTI_SELECT(action, _ref2) {
    ...
    (0, _a11y.speak)((0, _i18n.sprintf)((0, _i18n.__)('%s blocks selected.'), blockCount), 'assertive');
  }
};
