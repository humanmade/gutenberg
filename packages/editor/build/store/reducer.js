...
function getMutateSafeObject(original, working) {
  if (original === working) {
    return (0, _objectSpread17.default)({}, original);
  }
...
(0, _withHistory.default)({
  ...
  blocks: (0, _lodash.flow)([_data.combineReducers, // Track whether changes exist, resetting at each post save. Relies on
