...
var settings = {
  ...
  save: function save(_ref11) {
    ...
    var classes = (0, _classnames3.default)(dimRatioToClass(dimRatio), overlayColorClass, (0, _defineProperty2.default)({
      'has-background-dim': dimRatio !== 0,
      'has-parallax': hasParallax
  ...
  deprecated: [{
    ...
    save: function save(_ref13) {
      ...
      var url = attributes.url,
          ...
          align = attributes.align;
      var style = backgroundImageStyles(url);
      var classes = (0, _classnames3.default)(dimRatioToClass(dimRatio), {
        'has-background-dim': dimRatio !== 0,
        'has-parallax': hasParallax
